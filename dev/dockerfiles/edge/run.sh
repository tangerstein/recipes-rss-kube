...
exec java -javaagent:agent/inspectit-agent.jar -Dinspectit.config=$CONFIG_PATH -Deureka.serviceUrl.default=http://$TOMCAT_ADRESS:8080/eureka/v2/ -jar rss-edge/build/libs/rss-edge*SNAPSHOT.jar
